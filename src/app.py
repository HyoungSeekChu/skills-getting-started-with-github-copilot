...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer training and weekly matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swim technique and compete in school swim meets",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["maria@mergington.edu", "jacob@mergington.edu"]
    },
    "Debate Team": {
